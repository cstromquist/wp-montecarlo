...
?>
<div class="mc-logos relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-10 lg:py-10 bg-white xl:rounded-lg md:-mt-20 flex justify-around flex-wrap shadow-xl">
