...
<div class="bg-gradient-to-b from-[#0073b4] to-[#005180]">
  <div class="flex min-h-[700px] max-w-screen-xl mx-auto px-4 items-center gap-2 pt-28 <?php echo esc_html($flex_hash[$alignment]); ?>">
    <div class="flex flex-col w-7/12">
      <h1 class="text-6xl text-white"><?php echo nl2br($heading); ?></h1>
      <h2 class="text-xl font-normal text-white lg:pt-8 m-0"><?php echo nl2br($subheading); ?></h2>
    ...
    <div class="w-5/12"><img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" class="w-full h-auto" /></div>
    <?php endif; ?>
  </div>
</div>
