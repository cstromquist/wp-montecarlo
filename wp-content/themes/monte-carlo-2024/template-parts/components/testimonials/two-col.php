<?php if ( have_rows( 'two_column_testimonial' ) ) : ?>
  <?php while ( have_rows( 'two_column_testimonial' ) ) : the_row(); ?>
  
    <?php 
      $layout = get_sub_field( 'double_image_options' ); 
      ...
      <div class="col-xs-12 col-sm-6">
        <?php if ( have_rows( 'testimonial_1' ) ) : ?>
          <?php while ( have_rows( 'testimonial_1' ) ) : the_row(); ?>
            <?php 
              $first_primary_image = get_sub_field( 'double_first_primary_image' );
              $first_logo = get_sub_field( 'double_first_logo' );
      ...
      <div class="col-xs-12 col-sm-6">
        <?php if ( have_rows( 'testimonial_2' ) ) : ?>
          <?php while ( have_rows( 'testimonial_2' ) ) : the_row(); ?>
            <?php 
              $second_primary_image = get_sub_field( 'second_primary_image' );
              $second_logo = get_sub_field( 'second_logo' );
